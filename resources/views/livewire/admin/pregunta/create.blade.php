<div class="card">
    <div class="card-header p-0">
        <h3 class="card-title">{{ __('CreateTitle', ['name' => __('Pregunta') ]) }}</h3>
        <div class="px-2 mt-4">
    ...
    <div class='form-group'>
        ...
        <input wire:model='estado' id='input-estado' class='form-check-input' type='checkbox' value="0" autocomplete='on'>
