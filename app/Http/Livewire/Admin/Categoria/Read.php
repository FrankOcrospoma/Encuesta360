...
class Read extends Component
{
    ...
    protected $listeners = ['categoriaDeleted'];

    public $sortType;
    public $sortColumn;

    public function categoriaDeleted(){
        // Nothing ..
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.categoria.read', [
            'categorias' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Categoria')) ]);
    }
}
